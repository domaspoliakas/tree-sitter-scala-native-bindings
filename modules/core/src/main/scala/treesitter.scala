...
object enumerations:
  import predef.*
  /**
   * [bindgen] header: /Users/dpol/misc/treesittr/treesitter-scala-native/tree-sitter/lib/include/tree_sitter/api.h
  */
...
private[treesitter] object extern_functions:
  ...
  */
   ...
   * [bindgen] header: /Users/dpol/misc/treesittr/treesitter-scala-native/tree-sitter/lib/include/tree_sitter/api.h
  */
  def ts_lookahead_iterator_advance(self : Ptr[TSLookaheadIterator]): Boolean = extern
...
object all:
  ...
  export _root_.treesitter.functions.ts_lookahead_iterator_advance
